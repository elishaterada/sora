...
private struct TerminalSettingsView: View {
    ...
    var body: some View {
        SettingsPage(title: "Terminal") {
            ...
            TerminalEffectsSettingsSection()
            Section("Appearance") {
...
private struct TerminalEffectsSettingsSection: View {
    ...
    var body: some View {
        Section("Playful effects") {
            ...
            Text("A soft teal glow across the sidebar and command area, with a little light as you type.")
                .font(.caption).foregroundStyle(.secondary)
            ...
            if let error = soundPreview.errorMessage {
                Text(error).font(.caption).foregroundStyle(SoraTheme.danger)
            }
        ...
        .onChange(of: soundProfile) { _ in soundPreview.stop() }
        .onChange(of: volume) { _ in soundPreview.stop() }
